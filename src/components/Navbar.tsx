              ...
              {navLinks.map((link) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Hover Underline using layoutId */}
                    <AnimatePresence>
                    ...
                    {/* Active State Underline (if not hovered) */}
                    {location.pathname === link.href && hoveredLink !== link.name && (
                      <div className="absolute bottom-0 left-0 w-full h-px bg-dusty-mauve" />
                    )}
                  </NavLink>
                </li>
              ))}
        ...
        {isOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-16">
              <Link to="/" onClick={() => setIsOpen(false)} className="flex flex-col items-start gap-1">
                ...
                {navLinks.map((link, i) => (
                  ...
                  >
                    <NavLink
                      ...
                      onClick={() => setIsOpen(false)}
                      className={({ isActive }) => 
                        `font-heading text-5xl uppercase tracking-tighter transition-colors block py-2 ${
